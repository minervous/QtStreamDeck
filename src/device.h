...
namespace streamdeck {
	...
	class STREAMDECKLIB_EXPORT Device : public QObject
	{
		...
		Q_PROPERTY(streamdeck::DeviceType expectedDeviceType READ expectedDeviceType WRITE setExpectedDeviceType NOTIFY expectedDeviceTypeChanged FINAL)
		Q_PROPERTY(streamdeck::DeviceType connectedDeviceType READ connectedDeviceType NOTIFY connectedDeviceTypeChanged FINAL)
	...
	public:
		...
		bool isOpen();
		int brightness();
		void setBrightness(int procentage);
